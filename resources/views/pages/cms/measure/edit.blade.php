...
<div class="m-card">
    ...
    <form method="post" action="{{ route('cms_measure_update', ['measure' => $measure->id]) }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <input type="radio" name="guidespecie_id" id="guide-specie-null" value="" @if(!count($municipality->guide_species))) checked @endif>
        ...
        <div class="form-group">
            <label>Opgave</label>
                ...
                <div class="form-group">
                    <input type="radio" name="problem_id" id="problem-null" value="" @if(!count($municipality->problems))) checked @endif>
